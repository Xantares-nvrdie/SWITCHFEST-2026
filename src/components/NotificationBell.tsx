...
export function NotificationBell() {
    ...
    return (
        ...
        >
            ...
            {unreadCount > 0 && (
                <span className="absolute top-1 right-1 flex items-center justify-center w-4 h-4 text-[9px] font-bold text-white bg-red-500 border-2 border-[var(--surface)] rounded-full">
