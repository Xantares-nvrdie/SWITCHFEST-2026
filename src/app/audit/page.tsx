        ...
        <div className="space-y-8">
            ...
            <div className="glass-panel p-4 rounded-2xl border-slate-800">
                <div className="relative w-full md:w-96">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-sm text-slate-200 focus:outline-none"
                    />
                </div>
            </div>
            ...
            <div className="glass-panel p-6 rounded-2xl border-slate-800 space-y-4">
                <h3 className="text-base font-bold text-white flex items-center gap-2">
                    <History className="w-4 h-4 text-amber-400" /> Log Aktivitas Sistem (Database & IP Inet)
                </h3>
                        ...
                        >
                            <div className="space-y-1">
                                ...
                                <div className="flex items-center gap-3 text-[11px] text-slate-500 pt-1">
                                    ...
                                    <span>•</span>
                                    <span className="flex items-center gap-1">
                                        <Globe className="w-3 h-3 text-cyan-400" /> IP: {log.ipAddress}
                                    </span>
                                </div>
                            </div>

                            <span className="text-[11px] font-mono text-slate-500 self-end md:self-center shrink-0">
                                {log.createdAt}
                            </span>
                        </div>
                    ))}
